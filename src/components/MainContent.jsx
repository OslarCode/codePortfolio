...
const MainContent = () => {
  return (
    <div className="flex flex-col items-center justify-center min-h-screen px-6 py-12 bg-gray-50 text-gray-800">
      {/* Hero Section */}
      ...
      <section id="contact" className="mt-12 text-center w-full">
        ...
        <a
          ...
          className="inline-block bg-indigo-600 text-white font-bold py-2 px-4 rounded hover:bg-indigo-500 transition duration-300"
        >
          Envíame un correo
        </a>
      </section>
